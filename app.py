...
def create_app(config_name='default'):
    ...
    def dashboard():
        ...
        member_projects = current_user.projects.all()  # Projects where user is a member
        ...
        # Alternative: Use the same approach as details route if you have task_counts on projects
        # Aggregate task counts across all user projects
        total_todo = 0
        total_in_progress = 0
        total_completed = 0
        ...
        # Fallback to user task counts if project task_counts doesn't exist or gives 0
